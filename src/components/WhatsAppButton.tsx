...
import { WHATSAPP_LINK } from '../utils/businessStatus';
...
export const WhatsAppButton: React.FC = () => {
  ...
  return (
    <div className="fixed z-50 bottom-[75px] sm:bottom-[80px] right-4 lg:bottom-[24px] lg:right-[24px] flex items-center gap-2">
      ...
      {/* Tooltip */}
      {showTooltip && (
        <div className="bg-[#4B2E5E] text-[#FAF7F2] text-xs font-bold px-3 py-1.5 rounded-lg shadow-lg border border-[#C9A86A]/50 animate-fadeIn whitespace-nowrap hidden sm:block">
          Chat on WhatsApp
        </div>
      )}
