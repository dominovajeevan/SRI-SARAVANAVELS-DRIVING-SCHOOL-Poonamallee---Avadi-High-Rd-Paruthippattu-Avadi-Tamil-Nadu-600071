      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[1, 2, 3].map((cardIdx) => (
            <div
              key={cardIdx}
              className="bg-white border border-[#E8DEC8] hover:border-[#C9A86A] rounded-2xl p-6 flex flex-col justify-between shadow-celestial-card"
            >
              <div>
                ...
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <span className="block text-[11px] text-[#665E6E]">Sri Saravana Vels Learner</span>
                  </div>
                </div>
